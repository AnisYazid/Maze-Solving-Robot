...
const int thres = 1100; //threshhold value, max sensor reading is 4095
bool irFull = false;
bool irRight = false;
bool irLeft = false;
...
void detectPostion(){
  ...
  else if ((sensorValues[0]>= thres ) && (sensorValues[7]<thres ))
    {
    irLeft=true;
    }

   
  else if ((sensorValues[7]>= thres ) && (sensorValues[0]<thres ))
    {
    irRight=true;
    }
